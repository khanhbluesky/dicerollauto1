...
// const adUnitId = __DEV__ ? TestIds.ADAPTIVE_BANNER : 'ca-app-pub-6968109228755506/8025005265';
const interstitial = InterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/3427284709', {
  requestNonPersonalizedAdsOnly: true
});

const rewardedInterstitial = RewardedInterstitialAd.createForAdRequest('ca-app-pub-6968109228755506/1415865898', {
  requestNonPersonalizedAdsOnly: true
});
...
export default function App() {
  ...
  const rollDice = () => {
    ...
    const newNumbers = Array.from({ length: 1 }, () => Math.floor(Math.random() * 6) + 1);
